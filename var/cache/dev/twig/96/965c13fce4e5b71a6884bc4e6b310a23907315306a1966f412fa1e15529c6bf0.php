...
/* post/new.html.twig */
class __TwigTemplate_cda756ea4da09d013184c15dddd01db3841043779c44a48fe3578cef10e50bf7 extends Template
{
    private $source;
    private $macros = [];
...
{% block body %}
    ...
    {{ form_widget(form) }}
        <button class=\"btn btn-success mt-5\">Add</button>
    {{ form_end(form) }}
{% endblock %}", "post/new.html.twig", "C:\\Users\\21268\\SymfonyPackage\\blog-symfony\\templates\\post\\new.html.twig");
    }
}
